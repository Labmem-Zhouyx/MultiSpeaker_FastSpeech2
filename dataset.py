...
class Dataset(Dataset):
    ...
    def reprocess(self, data, idxs):
        ...
        ref_mel_lens = np.array([mel.shape[0] for mel in ref_mels])
...
class TextDataset(Dataset):
    ...
    def collate_fn(self, data):
        ...
        # not use speaker id
        speakers = np.array([0 for _ in data])
        ...
        return ids, raw_texts, texts, text_lens, max(text_lens), speakers, ref_mels, ref_mel_lens
